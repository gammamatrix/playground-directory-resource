<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="sublocation_type" label="Sublocation Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Sublocation" :records="$parents"/>
    @endif
