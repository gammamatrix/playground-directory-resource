...
/**
 * \Playground\Directory\Resource\Http\Requests\Sublocation\RevisionsRequest
 */
class RevisionsRequest extends BaseIndexRequest
{
    ...
    protected array $paginationIds = [
        ...
        'sublocation_type' => ['column' => 'sublocation_type', 'label' => 'Sublocation Type', 'type' => 'string', 'nullable' => true],
    ...
    protected array $sortable = [
        ...
        'sublocation_type' => ['column' => 'sublocation_type', 'label' => 'Sublocation Type', 'type' => 'string'],
