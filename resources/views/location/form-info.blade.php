<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="location_type" label="Location Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Location" :records="$parents"/>
    @endif
